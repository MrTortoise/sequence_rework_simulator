...
describe("scenarios for back to start simulator", ()=>{
    test('3 tasks task will a surprising amount of time', () => {
      ...
      test('3 tasks task with only QA failure a surprising amount of time', () => {
      ...
      test('4 tasks task will a surprising amount of time', () => {
      ...
      test('2 tasks reversed  will a  less surprising amount of time', () => {
      ...
      test('4 tasks first reversed rest halved  will a surprising amount of time', () => {
